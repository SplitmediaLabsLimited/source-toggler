...
},{"../../internal/item":23,"../../internal/util/json":24,"../../internal/util/mixin":25,"../../internal/util/xml":26,"../environment":5,"../scene":17,"./ilayout":14}],16:[function(require,module,exports){
/// <reference path="../../../defs/es6-promise.d.ts" />
var item_1 = require('../../internal/item');
var transition_1 = require('../transition');
        ...
        return new Promise(function (resolve, reject) {
            if (environment_1.Environment.isSourcePlugin()) {
                ...
                Scene.getActiveScene().then(function (scene) {
                    ...
                    if ((Number(id) - 1) === _this.id && environment_1.Environment.isSourceConfig()) {
                        ...
                        _this.getName().then(function (name) {
                            sceneName = name;
                            return app_1.App.getAsList('presetconfig:' + _this.id);
                            ...
                            if (Array.isArray(jsonArr)) {
                                ...
                                app_1.App.set('presetconfig:' + _this.id, xml_1.XML.parseJSON(newOrder).toString()).then(function () {
                                    resolve(_this);
                                });
                            }
                            else {
